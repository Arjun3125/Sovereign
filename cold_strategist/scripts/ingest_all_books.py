...
BASE_DIR = Path(__file__).resolve().parents[2]  # up to repo root
sys.path.insert(0, str(BASE_DIR))

from cold_strategist.ingest_v2.ingest_v2 import ingest_v2
from cold_strategist.ingest_v2.llm_client import LLMError
from cold_strategist.ingest_v2.validators import ValidationError
